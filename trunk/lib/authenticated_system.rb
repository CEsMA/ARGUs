module AuthenticatedSystem
  protected
    ...
    def current_usuario
      @current_usuario ||= (session[:usuario] && Usuario.find_by_id(session[:usuario])) || :false
    end
    ...
    def login_required
      ...
      self.current_usuario ||= Usuario.authenticate(username, passwd) || :false if username && passwd
    ...
    def login_from_cookie
      ...
      user = Usuario.find_by_remember_token(cookies[:auth_token])

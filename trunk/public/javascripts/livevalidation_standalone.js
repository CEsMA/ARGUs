...
var Validate = {
    ...
    Numericality: function(value, paramsObj){
        ...
        var notANumberMessage = paramsObj.notANumberMessage || "Debe ser numérico"; //"Must be a number!";
    	...
    	var tooLowMessage = paramsObj.tooLowMessage || "No puede estar por debajo de " + minimum + ".";
    	var tooHighMessage = paramsObj.tooHighMessage || "No debe exceder " + maximum + ".";
    ...
    Format: function(value, paramsObj){
    	...
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Inválido";
    ...
    Email: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Debe ingresar una dirección de correo válida.";
    ...
    Length: function(value, paramsObj){
    	...
    	var maximum = ((paramsObj.maximum) || (paramsObj.maximum == 0)) ? paramsObj.maximum : null;
    	var is = ((paramsObj.is) || (paramsObj.is == 0)) ? paramsObj.is : null;
        var wrongLengthMessage = paramsObj.wrongLengthMessage || "Debe tener "+is+" caracteres de longitud.";//"Must be " + is + " characters long!";
    	var tooShortMessage = paramsObj.tooShortMessage || "El campo debe tener al menos "+minimum+" caracteres."; //"Must not be less than " + minimum + " characters long!";
    	var tooLongMessage = paramsObj.tooLongMessage || "El número no debe exceder los "+maximum+" caracteres."; //"Must not be more than " + maximum + " characters long!";
    	switch(true){
    	  	case (is !== null):
    ...
    Inclusion: function(value, paramsObj){
    	var paramsObj = paramsObj || {};
    	var message = paramsObj.failureMessage || "Recuerde ingresar sólo elementos contenidos en la lista"; //"Must be included in the list!";
    ...
    Exclusion: function(value, paramsObj){
        var paramsObj = paramsObj || {};
    	paramsObj.failureMessage = paramsObj.failureMessage || "No puede ingresar elementos que esten contenidos en la lista"//"Must not be included in the list!";
